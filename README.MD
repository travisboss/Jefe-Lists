...
1. allowlist.txt - This is a compiled down list from [AdguardTeam HttpsExclusions](https://github.com/AdguardTeam/HttpsExclusions), simply removing a lot of comments and any parts that are not allowed per Adguard.
